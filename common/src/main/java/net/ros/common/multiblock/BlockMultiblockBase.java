...
public abstract class BlockMultiblockBase<T extends TileBase & ITileMultiblockCore> extends BlockMachineBase<T>
        implements IWrenchable
{
    ...
    public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune)
    {
        ...
        {
            if (Machines.contains(Blueprint.class, this.getMultiblock().getDescriptor().getName()))
                drops.add(((ItemMultiblockBox) ROSItems.MULTIBLOCK_BOX).getBox(this.getMultiblock().getDescriptor()
                        .get(Blueprint.class)));
            else
