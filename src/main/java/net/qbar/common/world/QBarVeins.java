...
public class QBarVeins
{
    ...
    {
        IRON_NICKEL = new OreVeinDescriptor().veinForm(EVeinForm.FLAT).heapForm(EVeinHeapForm.PLATES).heapQty(5)
                .heapDensity(0.8f).heapSize(10).rarity(0.002f)
        ...
        IRON_COPPER = new OreVeinDescriptor().veinForm(EVeinForm.FLAT).heapForm(EVeinHeapForm.PLATES).heapQty(5)
                .heapDensity(0.7f).heapSize(10).rarity(0.002f)
        ...
        TIN = new OreVeinDescriptor().veinForm(EVeinForm.UPWARD).heapForm(EVeinHeapForm.PLATES).heapQty(5)
                .heapDensity(0.5f).heapSize(15).rarity(0.001f)
        ...
        IRON_ZINC = new OreVeinDescriptor().veinForm(EVeinForm.FLAT).heapForm(EVeinHeapForm.PLATES).heapQty(6)
                .heapDensity(0.75f).heapSize(13).rarity(0.0015f)
