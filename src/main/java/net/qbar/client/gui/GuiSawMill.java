...
{
    public static final ResourceLocation BACKGROUND = new ResourceLocation(QBar.MODID, "textures/gui/sawmill.png");

    public GuiSawMill(final EntityPlayer player, final TileSawMill sawmill)
    {
        super(player, sawmill, BACKGROUND);

        this.addSteamTank(sawmill.getSteamTank(), 151, 7, 18, 73);
