...
public class TileStructure extends TileBase implements ITileMultiblockCore
{
    ...
    public void readFromNBT(final NBTTagCompound tag)
    {
        ...
        this.blueprint = Machines.getComponent(Blueprint.class, tag.getString("blueprint"));
    ...
    public List<BakedQuad> getQuads()
    {
        if (this.quadsCache == null || this.previousStep != this.getBlueprintState().getCurrentStep())
        {
            final IBlockState state = Block
                    .getBlockFromName(ROSConstants.MODID + ":" + this.getBlueprint().getDescriptor().getName())
