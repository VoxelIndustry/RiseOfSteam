...
public class BlockSplitter extends BlockOrientableMachine<TileSplitter>
{
    ...
    {
        return new BlockStateContainer(this, FACING, BlockSplitter.FILTER);
    }
                                    ...
                                    final float hitZ)
    {
        ...
        {
            player.openGui(ROSConstants.MODINSTANCE, LogisticGui.SPLITTER.getUniqueID(), w, pos.getX(), pos.getY(),
                    pos.getZ());
            return true;
        }
