...
import net.ros.common.tile.TileFluidValve;
import net.ros.common.tile.TilePipeBase;

import javax.annotation.Nullable;

public class BlockFluidValve extends BlockMachineBase<TileFluidValve>
{
    ...
    {
        super("fluidvalve", Material.IRON, TileFluidValve.class);
                                    ...
                                    EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        if (!w.isRemote)
        {
            TileFluidValve valve = (TileFluidValve) w.getTileEntity(pos);
            if (valve == null)
                return false;
                                ...
                                final BlockPos posNeighbor)
    {
        if (!w.isRemote)
        {
            ...
            TileFluidValve pipe = this.getWorldTile(w, pos);
