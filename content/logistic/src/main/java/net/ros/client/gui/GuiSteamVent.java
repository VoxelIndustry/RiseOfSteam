...
public class GuiSteamVent extends BrokkGuiContainer<BuiltContainer>
{
    ...
    public GuiSteamVent(EntityPlayer player, TileSteamVent vent)
    {
        ...
        PressureControlPane pane = new PressureControlPane(vent.getMaxPressure(), 0.25f, null, null,
                vent.getBufferTank());

        mainPanel.addChild(pane, this.getWidth() / 2 - pane.getWidth() / 2, 79 - pane.getHeight());
