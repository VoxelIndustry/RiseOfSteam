...
public class QBarVeins
{
    ...
    public static void initVeins()
    {
        ...
        IRON_NICKEL = new OreVeinDescriptor("iron-nickel").veinForm(EVeinForm.FLAT).heapForm(EVeinHeapForm.PLATES)
                ...
                .poorChance(0, 0.8f)
                .content(((BlockVeinOre) QBarBlocks.IRON_NICKEL_ORE).getStateFromOre(QBarOres.PENTLANDITE), 0.3f)
                .content(((BlockVeinOre) QBarBlocks.IRON_NICKEL_ORE).getStateFromOre(QBarOres.GARNIERITE), 0.3f)
                .content(((BlockVeinOre) QBarBlocks.IRON_NICKEL_ORE).getStateFromOre(QBarOres.LATERITE), 0.4f)
        ...
        IRON_COPPER = new OreVeinDescriptor("iron-copper").veinForm(EVeinForm.FLAT).heapForm(EVeinHeapForm.PLATES)
                ...
                .poorChance(0, 0.8f)
                .content(((BlockVeinOre) QBarBlocks.IRON_COPPER_ORE).getStateFromOre(QBarOres.CHALCOPYRITE), 0.3f)
                .content(((BlockVeinOre) QBarBlocks.IRON_COPPER_ORE).getStateFromOre(QBarOres.TETRAHEDRITE), 0.3f)
                .content(((BlockVeinOre) QBarBlocks.IRON_COPPER_ORE).getStateFromOre(QBarOres.MALACHITE), 0.4f)
        ...
        TIN = new OreVeinDescriptor("tin").veinForm(EVeinForm.UPWARD).heapForm(EVeinHeapForm.PLATES).heapQty(5)
                .heapDensity(0.5f).heapSize(15).rarity(0.001f).heightRange(4, 64).richChance(0.1f, 0.8f).poorChance
                        (0, 0.8f)
                .content(((BlockVeinOre) QBarBlocks.TIN_ORE).getStateFromOre(QBarOres.CASSITERITE), 1)
                .content(((BlockVeinOre) QBarBlocks.TIN_ORE).getStateFromOre(QBarOres.TEALLITE), 1)
        ...
        IRON_ZINC = new OreVeinDescriptor("iron-zinc").veinForm(EVeinForm.FLAT).heapForm(EVeinHeapForm.PLATES)
                ...
                .poorChance(0, 0.8f)
                .content(((BlockVeinOre) QBarBlocks.IRON_ZINC_ORE).getStateFromOre(QBarOres.SPHALERITE), 1)
        ...
        GOLD = new OreVeinDescriptor("gold").veinForm(EVeinForm.SCATTERED).heapForm(EVeinHeapForm.SCATTERED).heapQty(1)
                .heapDensity(0.1f).heapSize(20).rarity(0.0001f).heightRange(4, 64).richChance(0, 0.6f).poorChance
                        (0.2f, 1f)
                .content(((BlockVeinOre) QBarBlocks.GOLD_ORE).getStateFromOre(QBarOres.GOLD_ORE), 1)
        ...
        REDSTONE = new OreVeinDescriptor("redstone").veinForm(EVeinForm.SCATTERED).heapForm(EVeinHeapForm.SPHERES)
                ...
                .poorChance(0, 0.8f)
                .content(((BlockVeinOre) QBarBlocks.REDSTONE_ORE).getStateFromOre(QBarOres.REDSTONE_ORE), 1)
